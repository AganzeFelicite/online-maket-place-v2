...
class UserController(
    ...
    fun updateUser(@RequestBody request: UserUpdateDTO.Input): ResponseEntity<BaseUserResponse> {
    ...
    fun getUserOrders(): ResponseEntity<List<OrderCreateDTO.Output>> {
    ...
    fun getUserOrdersByStatus(@PathVariable status: String): ResponseEntity<List<OrderCreateDTO.Output>> {
    ...
    fun getUserOrdersByUserId(@PathVariable userId: Long): ResponseEntity<List<OrderCreateDTO.Output>> {
